...
\toprule
\toprule
\textbf{Elementary flow} & \textbf{Complex potential}, $F = \phi + i \psi$ & \textbf{Potential}, $\phi(x, y)$ & \textbf{Streamfunction}, $\psi(x, y)$ & \textbf{Sketch of streamlines} \\
\midrule
\midrule
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tikzpicture}[scale=1, baseline=2.5ex]
    % Axes
...
\begin{tikzpicture}[scale=1, baseline=2.75ex]
    % Axes
    \draw[->, line width=1pt, gray] (-0.5,0) -- (1.5,0) node[right] {$x$};
    \draw[->, line width=1pt, gray] (0,-0.5) -- (0,1.5) node[above] {$iy$};

    % Eight rays to represent the source
    \def\ss{0.8}
    \foreach \angle in {0,45,...,315} {
    	\draw[->] (\ss,\ss) -- ({\ss+cos(\angle)}, {\ss+sin(\angle)});
    }
    \filldraw[black] (\ss,\ss) circle (2pt);
\end{tikzpicture}
 \\
\midrule
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
