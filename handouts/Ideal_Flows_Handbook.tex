...
\toprule
\toprule
\textbf{Elementary flow} & \textbf{Complex potential}, $F = \phi + i \psi$ & \textbf{Potential}, $\phi(x, y)$ or $\phi(r, \theta)$ & \textbf{Streamfunction}, $\psi(x, y)$ or $\psi(r, \theta)$ & \textbf{Sketch of streamlines} \\
\midrule
\midrule
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
