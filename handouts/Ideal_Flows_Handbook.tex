...
\section*{\centering A Brief Handbook of Elementary Ideal Flows\blfootnote{Inspired by Tables 12.1 and 12.2 of Granger's \emph{Fluid Mechanics} (Dover Publications, 2012). Flow 1--5 are the ``building blocks'' and the rest are superposition examples.}}
...
\toprule
\toprule
\thead[l]{\textbf{Elementary flow}} & \thead[l]{\textbf{Complex potential}, $F = \phi + i \psi$} & \thead[l]{\textbf{Potential}, $\phi(x, y)$ or $\phi(r, \theta)$} & \thead[l]{\textbf{Streamfunction}, $\psi(x, y)$ or $\psi(r, \theta)$} & \thead[l]{\textbf{Sketch of streamlines}} \\
\midrule
\midrule
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
